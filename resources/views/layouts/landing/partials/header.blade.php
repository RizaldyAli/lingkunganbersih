<nav class="navbar navbar-expand-lg py-0">
    <div class="container">
        <a class="navbar-brand me-0 py-0" href="{{ route('landing') }}">
            <img src="{{ asset('assets/landing/dist/images/logos/logo-dark.svg') }}" alt="img-fluid">
        </a>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div
                                            ...
                                            <img src="{{ asset('assets/landing/dist/images/demos/demo-main.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/demos/demo-dark.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/demos/demo-horizontal.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/demos/demo-minisidebar.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/demos/demo-rtl.jpg') }}"
                                                alt="" class="img-fluid">
                            ...
                            <div class="col-lg-12">
                                <div class="row justify-content-between">
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/apps/app-calendar.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/apps/app-chat.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/apps/app-email.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/apps/app-contact.jpg') }}"
                                                alt="" class="img-fluid">
                                    ...
                                    <div class="col">
                                        <div
                                            class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                            <img src="{{ asset('assets/landing/dist/images/apps/app-invoice.jpg') }}"
                                                alt="" class="img-fluid">
                                                ...
                                                <div class="position-relative">
                                                    <a target="_blank" href="../package/html/main/app-chat.html"
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-chat.svg') }}"
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-invoice.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-invoice.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-contact2.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-mobile.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-email.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-message-box.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                            ...
                                            <div class="col-6">
                                                <div class="position-relative">
                                                    <a target="_blank"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-cart.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-calendar.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-date.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-contact.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-lifebuoy.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
                                                    ...
                                                    <a target="_blank" href="../package/html/main/app-notes.html"
                                                        ...
                                                        <div
                                                            class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                            <img src="{{ asset('assets/landing/dist/images/svgs/icon-dd-application.svg') }}"
                                                                alt="" class="img-fluid" width="24"
                                                                height="24">
                                                        </div>
                                                        <div class="d-inline-block">
