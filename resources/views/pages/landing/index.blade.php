            ...
            <div class="domo-contect position-relative">
                <div class="demos-view mt-11 pt-lg-8">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/demos/demo-minisidebar.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/demos/demo-rtl.jpg') }}" alt=""
                                    class="img-fluid">
                ...
                <div class="demos-view mt-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-calendar.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-chat.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-email.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-contact.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-invoice.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/modernize-bt-app-contact-list.jpg') }}"
                                    alt="" class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-user-profile.jpg') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/modernize-vue-app-blog.jpg') }}"
                                    alt="" class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/modernize-vue-app-blog-detail.jpg') }}"
                                    alt="" class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/modernize-vue-app-shop.jpg') }}"
                                    alt="" class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-ecommerce-detail.jpg') }}"
                                    alt="" class="img-fluid">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                            <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                <img src="{{ asset('assets/landing/dist/images/apps/app-ecommerce-list.jpg') }}" alt=""
                                    class="img-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="sliding-wrapper position-relative overflow-hidden">
                <div class="slide-background d-flex flex-row w-100">
                    <div class="slide">
                        <img src="{{ asset('assets/landing/dist/images/slider/slider-group.png') }}" alt="slide"
                            height="100%">
                    </div>
                    <div class="slide">
                        <img src="{{ asset('assets/landing/dist/images/slider/slider-group.png') }}" alt="slide"
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <div>
                                        <ul class="list-unstyled d-flex align-items-center justify-content-end gap-1 mb-0">
                                            <li>
                                                <a href="">
                                                    <img src="{{ asset('assets/landing/dist/images/svgs/icon-star.svg') }}"
                                                        alt="" class="img-fluid">
                                                </a>
                                            </li>
                                            <li>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="text-center text-lg-end">
                        <img src="{{ asset('assets/landing/dist/images/backgrounds/business-woman-checking-her-mail.png') }}"
                            alt="" class="img-fluid">
                    </div>
                </div>
            </div>
